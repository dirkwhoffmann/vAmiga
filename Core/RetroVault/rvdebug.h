 ...
 *
 * Note that RetroVault maintains its own, independent set of flags, separate
 * from vAmiga's core flags (debug.h).
 */
...
#define RV_LOG_FLAGS(E)                                                       \
                                                                              \
    /* File systems */                                                        \
    E(LOG_FS,         LOG_OFF,  "File system classes (OFS / FFS)")        \
                                                                              \
    /* Image files */                                                         \
    E(LOG_HDF,        LOG_OFF,  "HDF and HDZ files")                      \
    E(LOG_DMS,        LOG_OFF,  "DMS files")                              \
...
#define RV_DEBUG_FLAGS(E)                                                     \
    ...
    E(FS_VERIFY,      false, "Verify file system integrity")            \
                                                                              \
    /* Hard drives */                                                         \
    E(HDR_ACCEPT_ALL, false, "Disable hard drive layout checks")        \
                                                                              \
