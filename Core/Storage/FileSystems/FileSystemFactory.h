...
public:
    ...
    [[deprecated]] static void initFromADF(FileSystem &fs, const ADFFile &adf);
    [[deprecated]] static void initFromHDF(FileSystem &fs, const HDFFile &hdf, isize part = 0);
    [[deprecated]] static void initFromMedia(FileSystem &fs, const MediaFile &file, isize part = 0);
    [[deprecated]] static void initFromFloppy(FileSystem &fs, const FloppyDrive &df);
    [[deprecated]] static void initFromHardDrive(FileSystem &fs, const HardDrive &hd, isize part = 0);
    [[deprecated]] static void initCreateEmpty(FileSystem &fs, isize capacity, isize blockSize = 512);
    [[deprecated]] static void initFromDescriptor(FileSystem &fs, const FSDescriptor &, const fs::path &path = {});
    [[deprecated]] static void initLowLevel(FileSystem &fs, Diameter dia, Density den, FSFormat dos, const fs::path &path = {});
};
