...
Headless::smokeTestScript[] = {
    ...
    "dmadebugger open",
    "dmadebugger close",
    "dmadebugger set DMA_CHANNEL0 true",
    "dmadebugger set DMA_CHANNEL0 false",
    "dmadebugger set DMA_CHANNEL1 true",
    "dmadebugger set DMA_CHANNEL1 false",
    "dmadebugger set DMA_CHANNEL2 true",
    "dmadebugger set DMA_CHANNEL2 false",
    "dmadebugger set DMA_CHANNEL3 true",
    "dmadebugger set DMA_CHANNEL3 false",
    "dmadebugger set DMA_CHANNEL4 true",
    "dmadebugger set DMA_CHANNEL4 false",
    "dmadebugger set DMA_CHANNEL5 true",
    "dmadebugger set DMA_CHANNEL5 false",
    "dmadebugger set DMA_CHANNEL6 true",
    "dmadebugger set DMA_CHANNEL6 false",
    "dmadebugger set DMA_CHANNEL7 true",
    "dmadebugger set DMA_CHANNEL7 false",
