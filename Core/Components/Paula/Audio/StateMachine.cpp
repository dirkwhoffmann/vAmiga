...
{
    debugmsg(AUD_DEBUG, "Disable DMA\n");
...
StateMachine<nr>::penhi()
{
    ...
    debugmsg(AUD_DEBUG, "penhi: %d %d\n", sample, scaled);

    if (!sampler.isFull()) {
        sampler.append(agnus.clock, scaled);
    } else {
        debugmsg(AUD_DEBUG, "penhi: Sample buffer is full\n");
    }
...
StateMachine<nr>::penlo()
{
    ...
    debugmsg(AUD_DEBUG, "penlo: %d %d\n", sample, scaled);

    if (!sampler.isFull()) {
        sampler.append(agnus.clock, scaled);
    } else {
        debugmsg(AUD_DEBUG, "penlo: Sample buffer is full\n");
    }
...
StateMachine<nr>::move_000_010() {
    ...
    debugmsg(AUD_DEBUG, "move_000_010\n");
...
StateMachine<nr>::move_000_001() {
    ...
    debugmsg(AUD_DEBUG, "move_000_001\n");
...
StateMachine<nr>::move_001_000() {
    ...
    debugmsg(AUD_DEBUG, "move_001_000\n");
...
StateMachine<nr>::move_001_101() {
    ...
    debugmsg(AUD_DEBUG, "move_001_101\n");
...
StateMachine<nr>::move_101_000() {
    ...
    debugmsg(AUD_DEBUG, "move_101_000\n");
...
StateMachine<nr>::move_101_010() {
    ...
    debugmsg(AUD_DEBUG, "move_101_010\n");
...
StateMachine<nr>::move_010_011() {
    ...
    debugmsg(AUD_DEBUG, "move_010_011\n");
...
StateMachine<nr>::move_010_000() {
    ...
    debugmsg(AUD_DEBUG, "move_010_000\n");
...
StateMachine<nr>::move_011_000() {
    ...
    debugmsg(AUD_DEBUG, "move_011_000\n");
...
{
    debugmsg(AUD_DEBUG, "move_011_010\n");
