...
{
    logtrace(COPREG_DEBUG, "pokeCOPCON(%04X)\n", value);
...
Copper::pokeCOPJMP1()
{
    logtrace(COPREG_DEBUG, "pokeCOPJMP1: Jumping to %X\n", cop1lc);
...
Copper::pokeCOPJMP2()
{
    logtrace(COPREG_DEBUG, "pokeCOPJMP2(): Jumping to %X\n", cop2lc);
...
{
    logtrace(COPREG_DEBUG, "COPPC: %X pokeCOPINS(%04X)\n", coppc0, value);
...
{
    logtrace(COPREG_DEBUG, "pokeCOP1LCH(%04X)\n", value);
...
{
    logtrace(COPREG_DEBUG, "pokeCOP1LCL(%04X)\n", value);
...
{
    logtrace(COPREG_DEBUG, "pokeCOP2LCH(%04X)\n", value);
...
{
    logtrace(COPREG_DEBUG, "pokeCOP2LCL(%04X)\n", value);
...
{
    logtrace(COPREG_DEBUG, "pokeNOOP(%04X)\n", value);
}
