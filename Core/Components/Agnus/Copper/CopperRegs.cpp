...
{
    logmsg(LOG_COPREG, "pokeCOPCON(%04X)\n", value);
...
Copper::pokeCOPJMP1()
{
    logmsg(LOG_COPREG, "pokeCOPJMP1: Jumping to %X\n", cop1lc);
...
Copper::pokeCOPJMP2()
{
    logmsg(LOG_COPREG, "pokeCOPJMP2(): Jumping to %X\n", cop2lc);
...
{
    logmsg(LOG_COPREG, "COPPC: %X pokeCOPINS(%04X)\n", coppc0, value);
...
{
    logmsg(LOG_COPREG, "pokeCOP1LCH(%04X)\n", value);
...
{
    logmsg(LOG_COPREG, "pokeCOP1LCL(%04X)\n", value);
...
{
    logmsg(LOG_COPREG, "pokeCOP2LCH(%04X)\n", value);
...
{
    logmsg(LOG_COPREG, "pokeCOP2LCL(%04X)\n", value);
...
{
    logmsg(LOG_COPREG, "pokeNOOP(%04X)\n", value);
}
