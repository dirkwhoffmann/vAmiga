...
{
    logme(LOG_COPREG, "pokeCOPCON(%04X)\n", value);
...
Copper::pokeCOPJMP1()
{
    logme(LOG_COPREG, "pokeCOPJMP1: Jumping to %X\n", cop1lc);
...
Copper::pokeCOPJMP2()
{
    logme(LOG_COPREG, "pokeCOPJMP2(): Jumping to %X\n", cop2lc);
...
{
    logme(LOG_COPREG, "COPPC: %X pokeCOPINS(%04X)\n", coppc0, value);
...
{
    logme(LOG_COPREG, "pokeCOP1LCH(%04X)\n", value);
...
{
    logme(LOG_COPREG, "pokeCOP1LCL(%04X)\n", value);
...
{
    logme(LOG_COPREG, "pokeCOP2LCH(%04X)\n", value);
...
{
    logme(LOG_COPREG, "pokeCOP2LCL(%04X)\n", value);
