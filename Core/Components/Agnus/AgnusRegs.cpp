...
{
    logdebug(DMA_DEBUG, "pokeDMACON(%04x)\n", value);
...
{
    logdebug(DMA_DEBUG, "setDMACON(%x, %x)\n", oldValue, value);
    ...
    if (oldValue == newValue) {
        ...
        logdebug(SEQ_DEBUG, "setDMACON: Skipping (value does not change)\n");
        return;
    }
...
{
    logdebug(DMA_DEBUG, "Copper DMA %s\n", value ? "on" : "off");
...
{
    logdebug(DMA_DEBUG, "Blitter DMA %s\n", value ? "on" : "off");
}

void
Agnus::setSPREN(bool value)
{
    logdebug(DMA_DEBUG, "Sprite DMA %s\n", value ? "on" : "off");
}

void
Agnus::setDSKEN(bool value)
{
    logdebug(DMA_DEBUG, "Disk DMA %s\n", value ? "on" : "off");
}
...
Agnus::peekVHPOSR() const
{
    ...
    logdebug(POSREG_DEBUG, "peekVHPOSR() = %04x\n", result);
    return result;
}
...
{
    logdebug(POSREG_DEBUG, "pokeVHPOS(%04x)\n", value);
...
Agnus::peekVPOSR() const
{
    ...
    logdebug(POSREG_DEBUG, "peekVPOSR() = %04x\n", result);
    return result;
}
...
{
    logdebug(POSREG_DEBUG, "pokeVPOS(%04x)\n", value);
...
Agnus::setVPOS(u16 value)
{
    ...
    if (pos.lol) {
        ...
        logdebug(NTSC_DEBUG, "Clearing the LOL bit\n");
        pos.lol = false;
        rectifyVBLEvent();
    }
...
{
    logdebug(DMA_DEBUG, "pokeBPLCON0(%04x)\n", value);
...
{
    logdebug(DMA_DEBUG, "setBPLCON0(%04x,%04x)\n", oldValue, newValue);
    ...
    if ((oldValue ^ newValue) & 0xF040) {
        ...
        if (bpldma()) {
            ...
            logdebug(SEQ_DEBUG, "setBPLCON0: Recomputing BPL event table\n");
            ...
            logdebug(SEQ_DEBUG, "setBPLCON0: Postponing recomputation\n");
        }
    }
...
{
    logdebug(DMA_DEBUG, "pokeBPLCON1(%04x)\n", value);
...
{
    logdebug(DIW_DEBUG, "pokeDIWSTRT<%s>(%04x)\n", AccessorEnum::key(s), value);
...
{
    logdebug(DIW_DEBUG, "pokeDIWSTOP<%s>(%04x)\n", AccessorEnum::key(s), value);
...
{
    logdebug(DIW_DEBUG, "pokeDIWHIGH<%s>(%04x)\n", AccessorEnum::key(s), value);
...
{
    logdebug(BPLMOD_DEBUG, "pokeBPL1MOD(%04x)\n", value);
...
{
    logdebug(BPLMOD_DEBUG, "setBPL1MOD(%04x)\n", value);
...
{
    logdebug(BPLMOD_DEBUG, "pokeBPL2MOD(%04x)\n", value);
...
{
    logdebug(BPLMOD_DEBUG, "setBPL2MOD(%04x)\n", value);
...
{
    logdebug(SPRREG_DEBUG, "pokeSPR%dPOS<%s>(%04x)\n", x, AccessorEnum::key(s), value);
...
{
    logdebug(SPRREG_DEBUG, "setSPR%dPOS(%04x)\n", x, value);
...
{
    logdebug(SPRREG_DEBUG, "pokeSPR%dCTL(%04x)\n", x, value);
...
{
    logdebug(SPRREG_DEBUG, "setSPR%dCTL(%04x)\n", x, value);
...
{
    logdebug(DSKREG_DEBUG, "pokeDSKPTH(%04x) [%s]\n", value, AccessorEnum::key(s));
...
{
    logdebug(DSKREG_DEBUG, "setDSKPTH(%04x)\n", value);
...
{
    logdebug(DSKREG_DEBUG, "pokeDSKPTL(%04x) [%s]\n", value, AccessorEnum::key(s));
...
{
    logdebug(DSKREG_DEBUG, "setDSKPTL(%04x)\n", value);
...
{
    loginfo(AUDREG_DEBUG, "pokeAUD%dLCH(%X)\n", x, value);
...
{
    logdebug(AUDREG_DEBUG, "pokeAUD%dLCL(%X)\n", x, value);
...
{
    logdebug(BPLREG_DEBUG, "pokeBPL%dPTH(%04x) [%s]\n", x, value, AccessorEnum::key(s));
...
{
    logdebug(BPLREG_DEBUG, "setBPL%dPTH(%X)\n", x, value);
...
{
    logdebug(BPLREG_DEBUG, "pokeBPL%dPTL(%04x) [%s]\n", x, value, AccessorEnum::key(s));
...
{
    logdebug(BPLREG_DEBUG, "setBPL%dPTL(%X)\n", x, value);
...
{
    logdebug(SPRREG_DEBUG, "pokeSPR%dPTH(%04x) [%s]\n", x, value, AccessorEnum::key(s));
...
{
    logdebug(SPRREG_DEBUG, "setSPR%dPTH(%04x)\n", x, value);
...
{
    logdebug(SPRREG_DEBUG, "pokeSPR%dPTL(%04x) [%s]\n", x, value, AccessorEnum::key(s));
