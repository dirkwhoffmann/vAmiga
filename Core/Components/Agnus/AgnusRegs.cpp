...
{
    debugmsg(DMA_DEBUG, "pokeDMACON(%04x)\n", value);
...
{
    debugmsg(DMA_DEBUG, "setDMACON(%x, %x)\n", oldValue, value);
    ...
    if (oldValue == newValue) {
        ...
        debugmsg(SEQ_DEBUG, "setDMACON: Skipping (value does not change)\n");
        return;
    }
...
{
    debugmsg(DMA_DEBUG, "Copper DMA %s\n", value ? "on" : "off");
...
{
    debugmsg(DMA_DEBUG, "Blitter DMA %s\n", value ? "on" : "off");
}

void
Agnus::setSPREN(bool value)
{
    debugmsg(DMA_DEBUG, "Sprite DMA %s\n", value ? "on" : "off");
}

void
Agnus::setDSKEN(bool value)
{
    debugmsg(DMA_DEBUG, "Disk DMA %s\n", value ? "on" : "off");
}
...
Agnus::peekVHPOSR() const
{
    ...
    debugmsg(POSREG_DEBUG, "peekVHPOSR() = %04x\n", result);
    return result;
}
...
{
    debugmsg(POSREG_DEBUG, "pokeVHPOS(%04x)\n", value);
...
Agnus::peekVPOSR() const
{
    ...
    debugmsg(POSREG_DEBUG, "peekVPOSR() = %04x\n", result);
    return result;
}
...
{
    debugmsg(POSREG_DEBUG, "pokeVPOS(%04x)\n", value);
...
Agnus::setVPOS(u16 value)
{
    ...
    if (pos.lol) {
        ...
        debugmsg(NTSC_DEBUG, "Clearing the LOL bit\n");
        pos.lol = false;
        rectifyVBLEvent();
    }
...
{
    debugmsg(DMA_DEBUG, "pokeBPLCON0(%04x)\n", value);
...
{
    debugmsg(DMA_DEBUG, "setBPLCON0(%04x,%04x)\n", oldValue, newValue);
    ...
    if ((oldValue ^ newValue) & 0xF040) {
        ...
        if (bpldma()) {
            ...
            debugmsg(SEQ_DEBUG, "setBPLCON0: Recomputing BPL event table\n");
            ...
            debugmsg(SEQ_DEBUG, "setBPLCON0: Postponing recomputation\n");
        }
    }
...
{
    debugmsg(DMA_DEBUG, "pokeBPLCON1(%04x)\n", value);
...
Agnus::setBPLCON1(u16 oldValue, u16 newValue)
{
    ...
    debugmsg(DMA_DEBUG, "setBPLCON1(%04x,%04x)\n", oldValue, newValue);
...
{
    debugmsg(DIW_DEBUG, "pokeDIWSTRT<%s>(%04x)\n", AccessorEnum::key(s), value);
...
{
    debugmsg(DIW_DEBUG, "pokeDIWSTOP<%s>(%04x)\n", AccessorEnum::key(s), value);
...
{
    debugmsg(DIW_DEBUG, "pokeDIWHIGH<%s>(%04x)\n", AccessorEnum::key(s), value);
...
{
    debugmsg(BPLMOD_DEBUG, "pokeBPL1MOD(%04x)\n", value);
...
{
    debugmsg(BPLMOD_DEBUG, "setBPL1MOD(%04x)\n", value);
...
{
    debugmsg(BPLMOD_DEBUG, "pokeBPL2MOD(%04x)\n", value);
...
{
    debugmsg(BPLMOD_DEBUG, "setBPL2MOD(%04x)\n", value);
...
{
    debugmsg(SPRREG_DEBUG, "pokeSPR%dPOS<%s>(%04x)\n", x, AccessorEnum::key(s), value);
...
{
    debugmsg(SPRREG_DEBUG, "setSPR%dPOS(%04x)\n", x, value);
...
{
    debugmsg(SPRREG_DEBUG, "pokeSPR%dCTL(%04x)\n", x, value);
...
{
    debugmsg(SPRREG_DEBUG, "setSPR%dCTL(%04x)\n", x, value);
...
{
    debugmsg(DSKREG_DEBUG, "pokeDSKPTH(%04x) [%s]\n", value, AccessorEnum::key(s));
...
{
    debugmsg(DSKREG_DEBUG, "setDSKPTH(%04x)\n", value);
...
{
    debugmsg(DSKREG_DEBUG, "pokeDSKPTL(%04x) [%s]\n", value, AccessorEnum::key(s));
...
{
    debugmsg(DSKREG_DEBUG, "setDSKPTL(%04x)\n", value);
...
{
    infomsg(AUDREG_DEBUG, "pokeAUD%dLCH(%X)\n", x, value);
...
{
    debugmsg(AUDREG_DEBUG, "pokeAUD%dLCL(%X)\n", x, value);
...
{
    debugmsg(BPLREG_DEBUG, "pokeBPL%dPTH(%04x) [%s]\n", x, value, AccessorEnum::key(s));
...
{
    debugmsg(BPLREG_DEBUG, "setBPL%dPTH(%X)\n", x, value);
...
{
    debugmsg(BPLREG_DEBUG, "pokeBPL%dPTL(%04x) [%s]\n", x, value, AccessorEnum::key(s));
...
{
    debugmsg(BPLREG_DEBUG, "setBPL%dPTL(%X)\n", x, value);
...
{
    debugmsg(SPRREG_DEBUG, "pokeSPR%dPTH(%04x) [%s]\n", x, value, AccessorEnum::key(s));
...
{
    debugmsg(SPRREG_DEBUG, "setSPR%dPTH(%04x)\n", x, value);
...
{
    debugmsg(SPRREG_DEBUG, "pokeSPR%dPTL(%04x) [%s]\n", x, value, AccessorEnum::key(s));
