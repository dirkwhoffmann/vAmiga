...
SocketServer::main()
{
    try {
        ...
        logme(SRV_DEBUG, "Server thread interrupted\n");
    ...
    while (isListening()) {
        ...
        try {
            ...
            try {
                ...
                logme(SRV_DEBUG, "Acting as a client\n");
                
            } catch (...) {
                
                // If there is no existing server, be the server
                logme(SRV_DEBUG, "Acting as a server\n");
            ...
            logme(SRV_DEBUG, "Main loop interrupted\n");
...
SocketServer::sessionLoop()
{
    ...
    try {
        ...
        logme(SRV_DEBUG, "Session loop interrupted\n");
