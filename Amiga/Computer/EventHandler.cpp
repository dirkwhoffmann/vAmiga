...
EventHandler::scheduleRel(EventSlot s, Cycle cycle, EventID id)
{
    ...
    // Pass to new API (remove this function later)
    switch (s) {
        case CIAA_SLOT: scheduleRel<CIAA_SLOT>(cycle, id); return;
        case CIAB_SLOT: scheduleRel<CIAB_SLOT>(cycle, id); return;
        case DMA_SLOT:  scheduleRel<DMA_SLOT>(cycle, id); return;
        case COP_SLOT:  scheduleRel<COP_SLOT>(cycle, id); return;
        case BLT_SLOT:  scheduleRel<BLT_SLOT>(cycle, id); return;
        case RAS_SLOT:  scheduleRel<RAS_SLOT>(cycle, id); return;
        case SEC_SLOT:  scheduleRel<SEC_SLOT>(cycle, id); return;
        default: assert(false);
    }
...
EventHandler::schedulePos(EventSlot s, int16_t vpos, int16_t hpos, EventID id)
{
    ...
    // Pass to new API (remove this function later)
    switch (s) {
        case CIAA_SLOT: schedulePos<CIAA_SLOT>(vpos, hpos, id); return;
        case CIAB_SLOT: schedulePos<CIAB_SLOT>(vpos, hpos, id); return;
        case DMA_SLOT:  schedulePos<DMA_SLOT>(vpos, hpos, id); return;
        case COP_SLOT:  schedulePos<COP_SLOT>(vpos, hpos, id); return;
        case BLT_SLOT:  schedulePos<BLT_SLOT>(vpos, hpos, id); return;
        case RAS_SLOT:  schedulePos<RAS_SLOT>(vpos, hpos, id); return;
        case SEC_SLOT:  schedulePos<SEC_SLOT>(vpos, hpos, id); return;
        default: assert(false);
    }
...
EventHandler::scheduleSecRel(EventSlot s, Cycle cycle, EventID id)
{
    ...
    // Pass to new API (remove this function later)
    switch (s) {
        case DSK_SLOT: scheduleRel<DSK_SLOT>(cycle, id); return;
        case IRQ_TBE_SLOT: scheduleRel<IRQ_TBE_SLOT>(cycle, id); return;
        case IRQ_DSKBLK_SLOT: scheduleRel<IRQ_DSKBLK_SLOT>(cycle, id); return;
        case IRQ_SOFT_SLOT: scheduleRel<IRQ_SOFT_SLOT>(cycle, id); return;
        case IRQ_PORTS_SLOT: scheduleRel<IRQ_PORTS_SLOT>(cycle, id); return;
        case IRQ_COPR_SLOT: scheduleRel<IRQ_COPR_SLOT>(cycle, id); return;
        case IRQ_VERTB_SLOT: scheduleRel<IRQ_VERTB_SLOT>(cycle, id); return;
        case IRQ_BLIT_SLOT: scheduleRel<IRQ_BLIT_SLOT>(cycle, id); return;
        case IRQ_AUD0_SLOT: scheduleRel<IRQ_AUD0_SLOT>(cycle, id); return;
        case IRQ_AUD1_SLOT: scheduleRel<IRQ_AUD1_SLOT>(cycle, id); return;
        case IRQ_AUD2_SLOT: scheduleRel<IRQ_AUD2_SLOT>(cycle, id); return;
        case IRQ_AUD3_SLOT: scheduleRel<IRQ_AUD3_SLOT>(cycle, id); return;
        case IRQ_RBF_SLOT: scheduleRel<IRQ_RBF_SLOT>(cycle, id); return;
        case IRQ_DSKSYN_SLOT: scheduleRel<IRQ_DSKSYN_SLOT>(cycle, id); return;
        case IRQ_EXTER_SLOT: scheduleRel<IRQ_EXTER_SLOT>(cycle, id); return;
        case REG_COP_SLOT: scheduleRel<REG_COP_SLOT>(cycle, id); return;
        case REG_CPU_SLOT: scheduleRel<REG_CPU_SLOT>(cycle, id); return;
        case TXD_SLOT: scheduleRel<TXD_SLOT>(cycle, id); return;
        case RXD_SLOT: scheduleRel<RXD_SLOT>(cycle, id); return;
        case POT_SLOT: scheduleRel<POT_SLOT>(cycle, id); return;
        case SYNC_SLOT: scheduleRel<SYNC_SLOT>(cycle, id); return;
...
EventHandler::scheduleSecPos(EventSlot s, int16_t vpos, int16_t hpos, EventID id)
{
    ...
    // Pass to new API (remove this function later)
    switch (s) {
        case DSK_SLOT: schedulePos<DSK_SLOT>(vpos, hpos, id); return;
        case IRQ_TBE_SLOT: schedulePos<IRQ_TBE_SLOT>(vpos, hpos, id); return;
        case IRQ_DSKBLK_SLOT: schedulePos<IRQ_DSKBLK_SLOT>(vpos, hpos, id); return;
        case IRQ_SOFT_SLOT: schedulePos<IRQ_SOFT_SLOT>(vpos, hpos, id); return;
        case IRQ_PORTS_SLOT: schedulePos<IRQ_PORTS_SLOT>(vpos, hpos, id); return;
        case IRQ_COPR_SLOT: schedulePos<IRQ_COPR_SLOT>(vpos, hpos, id); return;
        case IRQ_VERTB_SLOT: schedulePos<IRQ_VERTB_SLOT>(vpos, hpos, id); return;
        case IRQ_BLIT_SLOT: schedulePos<IRQ_BLIT_SLOT>(vpos, hpos, id); return;
        case IRQ_AUD0_SLOT: schedulePos<IRQ_AUD0_SLOT>(vpos, hpos, id); return;
        case IRQ_AUD1_SLOT: schedulePos<IRQ_AUD1_SLOT>(vpos, hpos, id); return;
        case IRQ_AUD2_SLOT: schedulePos<IRQ_AUD2_SLOT>(vpos, hpos, id); return;
        case IRQ_AUD3_SLOT: schedulePos<IRQ_AUD3_SLOT>(vpos, hpos, id); return;
        case IRQ_RBF_SLOT: schedulePos<IRQ_RBF_SLOT>(vpos, hpos, id); return;
        case IRQ_DSKSYN_SLOT: schedulePos<IRQ_DSKSYN_SLOT>(vpos, hpos, id); return;
        case IRQ_EXTER_SLOT: schedulePos<IRQ_EXTER_SLOT>(vpos, hpos, id); return;
        case REG_COP_SLOT: schedulePos<REG_COP_SLOT>(vpos, hpos, id); return;
        case REG_CPU_SLOT: schedulePos<REG_CPU_SLOT>(vpos, hpos, id); return;
        case TXD_SLOT: schedulePos<TXD_SLOT>(vpos, hpos, id); return;
        case RXD_SLOT: schedulePos<RXD_SLOT>(vpos, hpos, id); return;
        case POT_SLOT: schedulePos<POT_SLOT>(vpos, hpos, id); return;
        case SYNC_SLOT: schedulePos<SYNC_SLOT>(vpos, hpos, id); return;
...
EventHandler::rescheduleSecAbs(EventSlot s, Cycle cycle)
{
    ...
    // Pass to new API (remove this function later)
    switch (s) {
        case DSK_SLOT: rescheduleAbs<DSK_SLOT>(cycle); return;
        case IRQ_TBE_SLOT: rescheduleAbs<IRQ_TBE_SLOT>(cycle); return;
        case IRQ_DSKBLK_SLOT: rescheduleAbs<IRQ_DSKBLK_SLOT>(cycle); return;
        case IRQ_SOFT_SLOT: rescheduleAbs<IRQ_SOFT_SLOT>(cycle); return;
        case IRQ_PORTS_SLOT: rescheduleAbs<IRQ_PORTS_SLOT>(cycle); return;
        case IRQ_COPR_SLOT: rescheduleAbs<IRQ_COPR_SLOT>(cycle); return;
        case IRQ_VERTB_SLOT: rescheduleAbs<IRQ_VERTB_SLOT>(cycle); return;
        case IRQ_BLIT_SLOT: rescheduleAbs<IRQ_BLIT_SLOT>(cycle); return;
        case IRQ_AUD0_SLOT: rescheduleAbs<IRQ_AUD0_SLOT>(cycle); return;
        case IRQ_AUD1_SLOT: rescheduleAbs<IRQ_AUD1_SLOT>(cycle); return;
        case IRQ_AUD2_SLOT: rescheduleAbs<IRQ_AUD2_SLOT>(cycle); return;
        case IRQ_AUD3_SLOT: rescheduleAbs<IRQ_AUD3_SLOT>(cycle); return;
        case IRQ_RBF_SLOT: rescheduleAbs<IRQ_RBF_SLOT>(cycle); return;
        case IRQ_DSKSYN_SLOT: rescheduleAbs<IRQ_DSKSYN_SLOT>(cycle); return;
        case IRQ_EXTER_SLOT: rescheduleAbs<IRQ_EXTER_SLOT>(cycle); return;
        case REG_COP_SLOT: rescheduleAbs<REG_COP_SLOT>(cycle); return;
        case REG_CPU_SLOT: rescheduleAbs<REG_CPU_SLOT>(cycle); return;
        case TXD_SLOT: rescheduleAbs<TXD_SLOT>(cycle); return;
        case RXD_SLOT: rescheduleAbs<RXD_SLOT>(cycle); return;
        case POT_SLOT: rescheduleAbs<POT_SLOT>(cycle); return;
        case SYNC_SLOT: rescheduleAbs<SYNC_SLOT>(cycle); return;
...
EventHandler::rescheduleSecRel(EventSlot s, Cycle cycle)
{
    ...
    // Pass to new API (remove this function later)
    switch (s) {
        case DSK_SLOT: rescheduleRel<DSK_SLOT>(cycle); return;
        case IRQ_TBE_SLOT: rescheduleRel<IRQ_TBE_SLOT>(cycle); return;
        case IRQ_DSKBLK_SLOT: rescheduleRel<IRQ_DSKBLK_SLOT>(cycle); return;
        case IRQ_SOFT_SLOT: rescheduleRel<IRQ_SOFT_SLOT>(cycle); return;
        case IRQ_PORTS_SLOT: rescheduleRel<IRQ_PORTS_SLOT>(cycle); return;
        case IRQ_COPR_SLOT: rescheduleRel<IRQ_COPR_SLOT>(cycle); return;
        case IRQ_VERTB_SLOT: rescheduleRel<IRQ_VERTB_SLOT>(cycle); return;
        case IRQ_BLIT_SLOT: rescheduleRel<IRQ_BLIT_SLOT>(cycle); return;
        case IRQ_AUD0_SLOT: rescheduleRel<IRQ_AUD0_SLOT>(cycle); return;
        case IRQ_AUD1_SLOT: rescheduleRel<IRQ_AUD1_SLOT>(cycle); return;
        case IRQ_AUD2_SLOT: rescheduleRel<IRQ_AUD2_SLOT>(cycle); return;
        case IRQ_AUD3_SLOT: rescheduleRel<IRQ_AUD3_SLOT>(cycle); return;
        case IRQ_RBF_SLOT: rescheduleRel<IRQ_RBF_SLOT>(cycle); return;
        case IRQ_DSKSYN_SLOT: rescheduleRel<IRQ_DSKSYN_SLOT>(cycle); return;
        case IRQ_EXTER_SLOT: rescheduleRel<IRQ_EXTER_SLOT>(cycle); return;
        case REG_COP_SLOT: rescheduleRel<REG_COP_SLOT>(cycle); return;
        case REG_CPU_SLOT: rescheduleRel<REG_CPU_SLOT>(cycle); return;
        case TXD_SLOT: rescheduleRel<TXD_SLOT>(cycle); return;
        case RXD_SLOT: rescheduleRel<RXD_SLOT>(cycle); return;
        case POT_SLOT: rescheduleRel<POT_SLOT>(cycle); return;
        case SYNC_SLOT: rescheduleRel<SYNC_SLOT>(cycle); return;
...
EventHandler::cancelSec(EventSlot s)
{
    ...
    // Pass to new API (remove this function later)
    switch (s) {
        case DSK_SLOT: cancel<DSK_SLOT>();
        case IRQ_TBE_SLOT: cancel<IRQ_TBE_SLOT>(); return;
        case IRQ_DSKBLK_SLOT: cancel<IRQ_DSKBLK_SLOT>(); return;
        case IRQ_SOFT_SLOT: cancel<IRQ_SOFT_SLOT>(); return;
        case IRQ_PORTS_SLOT: cancel<IRQ_PORTS_SLOT>(); return;
        case IRQ_COPR_SLOT: cancel<IRQ_COPR_SLOT>(); return;
        case IRQ_VERTB_SLOT: cancel<IRQ_VERTB_SLOT>(); return;
        case IRQ_BLIT_SLOT: cancel<IRQ_BLIT_SLOT>(); return;
        case IRQ_AUD0_SLOT: cancel<IRQ_AUD0_SLOT>(); return;
        case IRQ_AUD1_SLOT: cancel<IRQ_AUD1_SLOT>(); return;
        case IRQ_AUD2_SLOT: cancel<IRQ_AUD2_SLOT>(); return;
        case IRQ_AUD3_SLOT: cancel<IRQ_AUD3_SLOT>(); return;
        case IRQ_RBF_SLOT: cancel<IRQ_RBF_SLOT>(); return;
        case IRQ_DSKSYN_SLOT: cancel<IRQ_DSKSYN_SLOT>(); return;
        case IRQ_EXTER_SLOT: cancel<IRQ_EXTER_SLOT>(); return;
        case REG_COP_SLOT: cancel<REG_COP_SLOT>(); return;
        case REG_CPU_SLOT: cancel<REG_CPU_SLOT>(); return;
        case TXD_SLOT: cancel<TXD_SLOT>(); return;
        case RXD_SLOT: cancel<RXD_SLOT>(); return;
        case POT_SLOT: cancel<POT_SLOT>(); return;
        case SYNC_SLOT: cancel<SYNC_SLOT>(); return;
        case INSPECTOR_SLOT: cancel<INSPECTOR_SLOT>(); return;
        default: assert(false);
    }
