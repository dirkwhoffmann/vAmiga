...
Blitter::doFastCopyBlit()
{
    ...
    plaindebug(DB_BLT_CHK, "BLITTER Blit %d (%d,%d) (%d%d%d%d) %x %x %x %x %s\n",
    ...
    plaindebug(DB_BLT_CHK, "BLITTER check1: %x check2: %x\n", check1, check2);
}
...
Blitter::doFastLineBlit()
{
    ...
    */
    ...
    plaindebug(DB_BLT_CHK, "BLITTER Line %d (%d,%d) (%d%d%d%d) %x %x %x %x\n",
