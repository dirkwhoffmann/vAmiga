...
static const char *script[] = {
    ...
    "dmadebugger open",
    "dmadebugger close",
    "dmadebugger copper true",
    "dmadebugger copper false",
    "dmadebugger blitter true",
    "dmadebugger blitter false",
    "dmadebugger disk true",
    "dmadebugger disk false",
    "dmadebugger audio true",
    "dmadebugger audio false",
    "dmadebugger sprites true",
    "dmadebugger sprites false",
    "dmadebugger bitplanes true",
    "dmadebugger bitplanes false",
    "dmadebugger cpu true",
    "dmadebugger cpu false",
    "dmadebugger refresh true",
    "dmadebugger refresh false",
