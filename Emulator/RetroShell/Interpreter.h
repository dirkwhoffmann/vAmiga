...
enum class Token
{
    ...
    down, hdn, details, disable, disconnect, disk, dma, dmadebugger, drive,
    dsksync, easteregg, eject, enable, esync, events, execbase, extrom,
    extstart, fast, filename, filesystem, filter, fpu, gdb, geometry, help,
    hide, host, ignore, init, info, insert, inspect, interrupt, interrupts,
    joystick, jump, keyboard, keyset, layers, left, library, libraries, list,
    load, lock, mechanics, memdump, memory, mmu, mode, model, monitor, mouse,
    next, none, opacity, open, os, overclocking, palette, pan, partition, path,
