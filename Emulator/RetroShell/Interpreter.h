...
enum class Token
{
    ...
    bankmap, bitplanes, blitter, breakpoints, brightness, bullets, catchpoints,
    channel, checksums, chip, cia, clear, close, clxsprspr, clxsprplf,
    clxplfplf, color, config, connect, contrast, controlport, copper, cpu,
    cutout, dc, debug, delay, denise, detach, device, devices, dfn, down, hdn,
    disable, disconnect, disk, dma, dmadebugger, drive, dsksync, easteregg,
    eject, enable, esync, events, execbase, extrom, extstart, fast, filename,
    filesystem, filter, gdb, geometry, help, hide, init, info, insert, inspect,
    interrupts, joystick, jump, keyboard, keyset, layers, left, library,
    libraries, list, load, lock, mechanics, memory, mode, model, monitor,
    mouse, none, off, on, opacity, open, os, palette, pan, partition, path,
    paula, pause, poll, port, ports, power, press, process, processes, pull,
    ...
    volumes, wait, watchpoints, wom, xaxis, yaxis, zorro
};
