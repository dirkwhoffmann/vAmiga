...
enum class Token
{
    ...
    down, hdn, disable, disconnect, disk, dma, dmadebugger, drive, dsksync,
    easteregg, eject, enable, esync, events, execbase, extrom, extstart, fast,
    filename, filesystem, filter, fpu, gdb, geometry, help, hide, host, ignore,
    init, info, insert, inspect, interrupt, interrupts, joystick, jump,
    ...
    opacity, open, os, overclocking, palette, pan, partition, path, paula,
    ...
    swtraps, syntax, task, tasks, tod, todbug, tracking, translate, trap, type,
    uart, unmappingtype, unpress, up, vector, vectors, verbose, velocity,
    volume, volumes, vsync, wait, watch, watchpoint, wom, wp, write, xaxis,
    yaxis, zorro
};
