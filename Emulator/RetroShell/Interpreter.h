...
enum class Token
{
    ...
    autosync, bankmap, bitplanes, blitter, bp, brightness, bullets, channel,
    checksums, chip, cia, clear, close, clxsprspr, clxsprplf, clxplfplf, color,
    config, connect, contrast, controlport, copper, cp, cpu, cutout, dc, debug,
    delay, del, denise, detach, device, devices, dfn, diagboard, down, hdn,
    ...
    release, reset, resource, resources, revision, right, rom, rshell, rtc,
