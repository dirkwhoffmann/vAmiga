...
enum class Token
{
    ...
    denise, detach, device, devices, dfn, dhn, disable, disconnect, disk, dma,
    dmadebugger, dsksync, easteregg, eject, enable, esync, events, execbase,
    extrom, extstart, fast, filename, filter, gdb, geometry, help, hide, init,
    info, insert, inspect, interrupts, joystick, jump, keyboard, keyset,
    layers, left, library, libraries, list, load, lock,mechanics, memory, mode,
    model, monitor, mouse, none, off, on, opacity, open, os, palette, pan, path,
