...
enum class Token
{
    about, accuracy, agnus, amiga, attach, audiate, audio, autofire, autosync,
    bankmap, bitplanes, blitter, brightness, bullets, channel, checksums, chip,
    cia, clear, close, clxsprspr, clxsprplf, clxplfplf, color, config, connect,
    contrast, controlport, copper, cpu, cutout, dc, debug, delay, denise,
    detach, device, devices, dfn, down, hdn, disable, disconnect, disk, dma,
    ...
    geometry, help, hide, init, info, insert, inspect, interrupts, joystick,
    jump, keyboard, keyset, layers, left, library, libraries, list, load,
    lock, mechanics, memory, mode, model, monitor, mouse, none, off, on,
    opacity, open, os, palette, pan, partition, path, paula, pause, poll, port,
    ports, power, press, process, processes, pull, pullup, raminitpattern,
    refresh, registers, regreset, regression, release, reset, resource,
    ...
    todbug, tracking, unmappingtype, up, verbose, velocity, volume, volumes,
    wait, wom, xaxis, yaxis, zorro
};
