...
enum class Token
{
    ...
    open, os, overclocking, palette, pan, partition, path, paula, pause, poll,
    port, ports, power, press, process, processes, pull, pullup, raminitpattern,
    ...
    sprites, start, state, status, step, stop, swapdelay, swtraps, task, tasks,
    tod, todbug, tracking, trap, unmappingtype, up, vector, verbose, velocity,
