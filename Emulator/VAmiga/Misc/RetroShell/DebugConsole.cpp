...
DebugConsole::initCommands(RetroShellCmd &root)
{
    ...
    root.add({
        ...
        .func   = [this] (Arguments& argv, const std::vector<isize> &values) {
            ...
            if (IS_ODD(addr)) throw CoreException(CoreError::ADDR_UNALIGNED);
    ...
    root.add({
        ...
        .func   = [this] (Arguments& argv, const std::vector<isize> &values) {
            ...
            if (nr < 0 || nr > 255) throw CoreException(CoreError::OPT_INV_ARG, "0...255");
    ...
    root.add({
        ...
        .func   = [this] (Arguments& argv, const std::vector<isize> &values) {
            ...
            auto nr = parseNum(argv[0]);
            if (nr < 1 || nr > 7) throw CoreException(CoreError::OPT_INV_ARG, "1...7");
    ...
    root.add({
        ...
        .func   = [this] (Arguments& argv, const std::vector<isize> &values) {
            ...
            auto nr = parseNum(argv[0]);
            if (nr < 0 || nr > 15) throw CoreException(CoreError::OPT_INV_ARG, "0...15");
    ...
    root.add({
        ...
        .func   = [this] (Arguments& argv, const std::vector<isize> &values) {
            ...
            switch (nr) {
                ...
                default:
                    throw CoreException(CoreError::OPT_INV_ARG, "1 or 2");
            }
        }
    });
