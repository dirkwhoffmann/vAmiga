...
public:
    ...
    CoreError check(Block nr, isize pos, u8 *expected, bool strict) const;
    ...
    CoreError checkBlockType(Block nr, FSBlockType type) const;
    CoreError checkBlockType(Block nr, FSBlockType type, FSBlockType altType) const;
