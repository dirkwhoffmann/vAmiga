    ...
    switch (opt) {
        ...
        case Opt::CPU_REVISION:
            ...
            if (!CPURevEnum::isValid(value)) {
                throw VAException(VAError::OPT_INV_ARG, CPURevEnum::keyList());
            }
            return;
        ...
        case Opt::CPU_DASM_REVISION:
            ...
            if (!DasmRevEnum::isValid(value)) {
                throw VAException(VAError::OPT_INV_ARG, DasmRevEnum::keyList());
            }
            return;
        ...
        case Opt::CPU_DASM_SYNTAX:
            ...
            if (!DasmSyntaxEnum::isValid(value)) {
                throw VAException(VAError::OPT_INV_ARG, DasmSyntaxEnum::keyList());
            }
            return;
        ...
        case Opt::CPU_DASM_NUMBERS:
            ...
            if (!DasmNumbersEnum::isValid(value)) {
                throw VAException(VAError::OPT_INV_ARG, DasmNumbersEnum::keyList());
            }
            return;
