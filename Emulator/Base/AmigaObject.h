...
enum Category : usize {
    ...
    BankMap   = 0b000000000001,
    Checksums = 0b000000000010,
    Config    = 0b000000000100,
    Disk      = 0b000000001000,
    Dma       = 0b000000010000,
    List1     = 0b000000100000,
    List2     = 0b000001000000,
    Registers = 0b000010000000,
    Segments  = 0b000100000000,
    State     = 0b001000000000,
    Signals   = 0b010000000000,
    Bus       = 0b100000000000,
};
}
