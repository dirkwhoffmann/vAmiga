...
Defaults::Defaults()
{
    ...
    setFallback(OPT_AUD_PAN1,                   350,                    { 0, 1} );
    setFallback(OPT_AUD_PAN2,                   350,                    { 0, 1} );
    setFallback(OPT_AUD_PAN3,                   50,                     { 0, 1} );
    setFallback(OPT_AUD_VOL0,                   100,                    { 0, 1} );
    setFallback(OPT_AUD_VOL1,                   100,                    { 0, 1} );
    setFallback(OPT_AUD_VOL2,                   100,                    { 0, 1} );
    setFallback(OPT_AUD_VOL3,                   100,                    { 0, 1} );
