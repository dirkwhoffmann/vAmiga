...
VAMIGA_ENUM(long, FSError)
{
    ...
    FS_EXPECTED_REF,
    FS_EXPECTED_SELFREF,
    FS_POINTS_TO_UNKNOWN_BLOCK,
    FS_POINTS_TO_EMPTY_BLOCK,
    FS_POINTS_TO_BOOT_BLOCK,
    FS_POINTS_TO_ROOT_BLOCK,
    FS_POINTS_TO_BITMAP_BLOCK,
    FS_POINTS_TO_USERDIR_BLOCK,
    FS_POINTS_TO_FILEHEADER_BLOCK,
    FS_POINTS_TO_FILELIST_BLOCK,
    FS_POINTS_TO_DATA_BLOCK,
