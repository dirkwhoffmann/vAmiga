...
static const char *script[] = {
    ...
    "",
    "cpu",
    "cpu set CPU_REVISION 68000",
    "cpu set CPU_REVISION 68010",
    "cpu set CPU_REVISION 68EC020",
    "cpu set CPU_DASM_REVISION 68000",
    "cpu set CPU_DASM_REVISION 68010",
    "cpu set CPU_DASM_REVISION 68EC020",
    "cpu set CPU_DASM_REVISION 68020",
    "cpu set CPU_DASM_REVISION 68EC030",
    "cpu set CPU_DASM_REVISION 68030",
    "cpu set CPU_DASM_REVISION 68EC040",
    "cpu set CPU_DASM_REVISION 68LC040",
    "cpu set CPU_DASM_REVISION 68040",
    "cpu set CPU_DASM_SYNTAX MOIRA",
    "cpu set CPU_DASM_SYNTAX MOIRA_MIT",
    "cpu set CPU_DASM_SYNTAX GNU",
    "cpu set CPU_DASM_SYNTAX GNU_MIT",
    "cpu set CPU_DASM_SYNTAX MUSASHI",
    "cpu set CPU_OVERCLOCKING 0",
    "cpu set CPU_OVERCLOCKING 1",
    "cpu set CPU_OVERCLOCKING 2",
    "cpu set CPU_RESET_VAL 0",

    "",
    "ciaa",
    "ciaa set CIA_REVISION MOS_8520_DIP",
    "ciaa set CIA_REVISION MOS_8520_PLCC",
    "ciaa set TODBUG true",
    "ciaa set TODBUG false",
    "ciaa set ECLOCK_SYNCING true",
    "ciaa set ECLOCK_SYNCING false",
    "ciaa set CIA_IDLE_SLEEP true",
    "ciaa set CIA_IDLE_SLEEP false",

    "",
    "ciab",
    "ciab set CIA_REVISION MOS_8520_DIP",
    "ciab set CIA_REVISION MOS_8520_PLCC",
    "ciab set TODBUG true",
    "ciab set TODBUG false",
    "ciab set ECLOCK_SYNCING true",
    "ciab set ECLOCK_SYNCING false",
    "ciab set CIA_IDLE_SLEEP true",
    "ciab set CIA_IDLE_SLEEP false",


    "",
    "agnus",
    "agnus set AGNUS_REVISION OCS_OLD",
    "agnus set AGNUS_REVISION OCS",
    "agnus set AGNUS_REVISION ECS_1MB",
    "agnus set AGNUS_REVISION ECS_2MB",
    ...
    "blitter",
    "blitter set BLITTER_ACCURACY 0",
    "blitter set BLITTER_ACCURACY 1",
    "blitter set BLITTER_ACCURACY 2",

    "denise",
    "denise set DENISE_REVISION OCS",
    "denise set DENISE_REVISION ECS",
    ...
    "dmadebugger set DMA_DEBUG_CHANNEL6 true",
    "dmadebugger set DMA_DEBUG_CHANNEL6 false",
    "dmadebugger set DMA_DEBUG_CHANNEL7 true",
    "dmadebugger set DMA_DEBUG_CHANNEL7 false",
    ...
    "paula audio",
    "paula audio filter",
    "paula audio filter set FILTER_TYPE NONE",
    "paula audio filter set FILTER_TYPE A500",
    "paula audio filter set FILTER_TYPE A1000",
    "paula audio filter set FILTER_TYPE A1200",
    "paula audio filter set FILTER_TYPE LOW",
    "paula audio filter set FILTER_TYPE LED",
    "paula audio filter set FILTER_TYPE HIGH",
    "paula audio set SAMPLING_METHOD NONE",
    "paula audio set SAMPLING_METHOD NEAREST",
    "paula audio set SAMPLING_METHOD LINEAR",
    "paula audio set AUDVOL0 50",
    "paula audio set AUDVOL1 50",
    "paula audio set AUDVOL2 50",
    "paula audio set AUDVOL3 50",
    "paula audio set AUDVOLL 50",
    "paula audio set AUDVOLR 50",
    "paula audio set AUDPAN0 50",
    "paula audio set AUDPAN1 50",
    "paula audio set AUDPAN2 50",
    "paula audio set AUDPAN3 50",

    "paula dc",
    "paula dc set DRIVE_SPEED 2",
    ...
    "rtc",
    "rtc set RTC_MODEL NONE",
    "rtc set RTC_MODEL OKI",
    "rtc set RTC_MODEL RICOH",

    "keyboard",
    "keyboard set ACCURATE_KEYBOARD 0",
    "keyboard set ACCURATE_KEYBOARD 1",
    "keyboard press 32",
    ...
    "serial",
    "serial set SER_DEVICE NONE",
    "serial set SER_DEVICE NULLMODEM",
    "serial set SER_DEVICE LOOPBACK",
    "serial set SER_DEVICE RETROSHELL",

    "df0",
    "df0 eject",
    "df0 searchpath \"tmp/\"",
    "df0 set DRIVE_TYPE DD_35",
    "df0 set DRIVE_RPM 300",
    "df0 set DRIVE_MECHANICS NONE",
    "df0 set DRIVE_MECHANICS A1010",
    "df0 set DISK_SWAP_DELAY 2",
    "df0 set DRIVE_PAN 50",
    ...
    "df1 eject",
    "df1 searchpath \"tmp/\"",
    "df1 set DRIVE_CONNECT true",
    "df1 set DRIVE_TYPE DD_35",
    "df1 set DRIVE_RPM 300",
    "df1 set DRIVE_MECHANICS NONE",
    "df1 set DRIVE_MECHANICS A1010",
    "df1 set DISK_SWAP_DELAY 2",
    "df1 set DRIVE_PAN 50",
    ...
    "hd1 set HDR_PAN 50",
    "hd1 set HDR_STEP_VOLUME 50",

    "server",
    "server serial",
    "server serial set SRV_PORT 8000",
    "server serial set SRV_VERBOSE true",
    "server serial set SRV_VERBOSE false",

    "server rshell",
    "server rshell set SRV_PORT 8000",
    "server rshell set SRV_VERBOSE true",
    "server rshell set SRV_VERBOSE false",

    "server gdb",
    "server gdb set SRV_PORT 8000",
    "server gdb set SRV_VERBOSE true",
    "server gdb set SRV_VERBOSE false",
