...
static const char *script[] = {
    ...
    "paula audio filter set type BUTTERWORTH",
    "paula audio filter set activation AUTO_ENABLE",
    "paula audio filter set activation ALWAYS_ON",
    "paula audio filter set activation ALWAYS_OFF",
