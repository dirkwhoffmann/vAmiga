...
static const char *script[] = {
    ...
    "paula audio set VOL0 50",
    "paula audio set VOL1 50",
    "paula audio set VOL2 50",
    "paula audio set VOL3 50",
    "paula audio set VOLL 50",
    "paula audio set VOLR 50",
    "paula audio set PAN0 50",
    "paula audio set PAN1 50",
    "paula audio set PAN2 50",
    "paula audio set PAN3 50",
