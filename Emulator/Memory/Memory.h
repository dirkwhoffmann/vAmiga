...
assert(((x) - 0xC00000) < (u32)config.slowSize);
...
#define READ_SLOW_8(x)      R8BE_ALIGNED (slow + ((x) % config.slowSize))
#define READ_SLOW_16(x)     R16BE_ALIGNED(slow + ((x) % config.slowSize))
...
#define WRITE_SLOW_8(x,y)   W8BE_ALIGNED (slow + ((x) % config.slowSize), (y))
#define WRITE_SLOW_16(x,y)  W16BE_ALIGNED(slow + ((x) % config.slowSize), (y))
