...
Defaults::Defaults()
{
    ...
    setFallback(Opt::MON_BLOOM_RADIUS,           20);
    setFallback(Opt::MON_BLOOM_BRIGHTNESS,       20);
    setFallback(Opt::MON_BLOOM_WEIGHT,           10);
    setFallback(Opt::MON_DOTMASK,                (i64)Dotmask::NONE);
    setFallback(Opt::MON_DOTMASK_BRIGHTNESS,     55);
    setFallback(Opt::MON_SCANLINES,              (i64)Scanlines::NONE);
    setFallback(Opt::MON_SCANLINE_BRIGHTNESS,    55);
    setFallback(Opt::MON_SCANLINE_WEIGHT,        11);
    setFallback(Opt::MON_DISALIGNMENT,           0);
    setFallback(Opt::MON_DISALIGNMENT_H,         25);
    setFallback(Opt::MON_DISALIGNMENT_V,         25);
    setFallback(Opt::MON_FLICKER,                true);
    setFallback(Opt::MON_FLICKER_WEIGHT,         25);
