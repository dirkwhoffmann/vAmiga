...
template<CPUModel C, Instr I, Mode M, Size S> void exec##x(u16 op);
...
template<CPUModel C, Instr I, Mode M, Size S> void execMulMusashi(u16 op);
template<CPUModel C, Instr I, Mode M, Size S> void execDivMusashi(u16 op);
