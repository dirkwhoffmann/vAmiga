...
- (instancetype) init
{
    ...
    dh0 = [[HardDriveProxy alloc] initWith:&amiga->hd0];
    dh1 = [[HardDriveProxy alloc] initWith:&amiga->hd1];
    dh2 = [[HardDriveProxy alloc] initWith:&amiga->hd2];
    dh3 = [[HardDriveProxy alloc] initWith:&amiga->hd3];
