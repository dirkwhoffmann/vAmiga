...
const VAmigaConstants VAMIGA = {
    ...
    .PAL.FREQUENCY.CLK = CLK_FREQUENCY_PAL,
    .PAL.FREQUENCY.DMA = DMA_FREQUENCY_PAL,
    .PAL.FREQUENCY.CPU = CPU_FREQUENCY_PAL,

    .PAL.VPOS.CNT_LF = VPOS_CNT_PAL_LF,
    .PAL.VPOS.CNT_SF = VPOS_CNT_PAL_SF,
    .PAL.VPOS.CNT = VPOS_CNT_PAL,
    .PAL.VPOS.MAX_LF = VPOS_MAX_PAL_LF,
    .PAL.VPOS.MAX_SF = VPOS_MAX_PAL_SF,
    .PAL.VPOS.MAX = VPOS_MAX_PAL,

    .PAL.HPOS.CNT_LL = HPOS_CNT_PAL,
    .PAL.HPOS.CNT_SL = HPOS_CNT_PAL,
    .PAL.HPOS.MAX_LL = HPOS_MAX_PAL,
    .PAL.HPOS.MAX_SL = HPOS_MAX_PAL,
    .PAL.HPOS.CNT = HPOS_CNT_PAL,
    .PAL.HPOS.MAX = HPOS_MAX_PAL,
    
    .PAL.VBLANK.MIN = VBLANK_MIN_PAL,
    .PAL.VBLANK.MAX = VBLANK_MAX_PAL,
    .PAL.VBLANK.CNT = VBLANK_CNT_PAL,

    .NTSC.FREQUENCY.CLK = CLK_FREQUENCY_NTSC,
    .NTSC.FREQUENCY.DMA = DMA_FREQUENCY_NTSC,
    .NTSC.FREQUENCY.CPU = CPU_FREQUENCY_NTSC,

    .NTSC.VPOS.CNT_LF = VPOS_CNT_NTSC_LF,
    .NTSC.VPOS.CNT_SF = VPOS_CNT_NTSC_SF,
    .NTSC.VPOS.CNT = VPOS_CNT_NTSC,
    .NTSC.VPOS.MAX_LF = VPOS_MAX_NTSC_LF,
    .NTSC.VPOS.MAX_SF = VPOS_MAX_NTSC_SF,
    .NTSC.VPOS.MAX = VPOS_MAX_NTSC,
    
    .NTSC.HPOS.CNT_LL = HPOS_CNT_NTSC_LL,
    .NTSC.HPOS.CNT_SL = HPOS_CNT_NTSC_SL,
    .NTSC.HPOS.MAX_LL = HPOS_MAX_NTSC_LL,
    .NTSC.HPOS.MAX_SL = HPOS_MAX_NTSC_SL,
    .NTSC.HPOS.CNT = HPOS_CNT_NTSC,
    .NTSC.HPOS.MAX = HPOS_MAX_NTSC,
    
    .NTSC.VBLANK.MIN = VBLANK_MIN_NTSC,
    .NTSC.VBLANK.MAX = VBLANK_MAX_NTSC,
    .NTSC.VBLANK.CNT = VBLANK_CNT_NTSC,
