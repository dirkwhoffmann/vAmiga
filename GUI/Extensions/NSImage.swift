...
public extension NSImage {
    ...
    /*
    func withFixedHue(_ hue: CGFloat) -> NSImage? {
        ...
        let c = NSColor(calibratedHue: hue, saturation: 1, brightness: 1, alpha: 1)
        var r: CGFloat = 0, g: CGFloat = 0, b: CGFloat = 0
        c.getRed(&r, green: &g, blue: &b, alpha: nil)

        // Multiply original luminance into this RGB (forces hue)
